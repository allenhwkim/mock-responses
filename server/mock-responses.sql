...
INSERT INTO mock_responses VALUES(1000000000000019,'graphic image','/cms/*.png',NULL,'',200,0,'image/png','data:image/png;base64,R0lGODlhDAAMAKIFAF5LAP/zxAAAANyuAP/gaP///wAAAAAAACH5BAEAAAUALAAAAAAMAAwAAAMlWLPcGjDKFYi9lxKBOaGcF35DhWHamZUW0K4mAbiwWtuf0uxFAgA7',1588308635797,'allen.kim',1620529981764,'allen.kim');
INSERT INTO mock_responses VALUES(3398820255760384,'foo bar','/foo/bar',NULL,'',200,0,'application/json','{"foo": 13}',1620683791240,'allen.kim',1620876389426,'allen.kim');
INSERT INTO mock_responses VALUES(3398829646807040,'graphic image','/cms/*.png',NULL,'',200,0,'image/png','data:image/png;base64,R0lGODlhDAAMAKIFAF5LAP/zxAAAANyuAP/gaP///wAAAAAAACH5BAEAAAUALAAAAAAMAAwAAAMlWLPcGjDKFYi9lxKBOaGcF35DhWHamZUW0K4mAbiwWtuf0uxFAgA7',1620688269808,'allen.kim',1620688269808,'allen.kim');
INSERT INTO mock_responses VALUES(3398859891933184,'Last Archived','/mock-responses/config','GET',NULL,200,NULL,'application/json',replace('{\n  "archiveUrl": "http://oneview-dev.rogers.com:8100/mock-responses/archive"\n}','\n',char(10)),1620702691012,'allen.kim',1622582658861,'allen.kim');
INSERT INTO mock_responses VALUES(3402802804031488,'/foo/archive/test','/foo/archive/test',NULL,'',200,0,'application/json','{}',1622582818240,'allen.kim',1622582818240,'allen.kim');
