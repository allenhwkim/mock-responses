...
INSERT INTO mock_responses VALUES(1000000000000008,NULL,1,'/cors/options/call','OPTIONS',200,NULL,'application/json','{}',1563894834295,'allen.kim',1563894834295,'allen.kim','');
INSERT INTO mock_responses VALUES(1000000000000009,'test233',0,'test','POST',200,0,'application/json','test',1570211678295,'allen.kim',1570211955896,'allen.kim','');
INSERT INTO mock_responses VALUES(1000000000000010,'test222',0,'test','POST',200,0,'application/json','test222',1570211949947,'allen.kim',1570212034458,'allen.kim','');
INSERT INTO mock_responses VALUES(1000000000000011,'test2',0,'/test2','POST',200,0,'application/json','test',1570211999314,'allen.kim',1588620142768,'allen.kim','');
INSERT INTO mock_responses VALUES(1000000000000012,'update',0,'test','POST',200,0,'application/json','test',1570212065007,'allen.kim',1570212161466,'allen.kim','');
INSERT INTO mock_responses VALUES(1000000000000013,'create',0,'fdasf','POST',200,0,'application/json','fdasf',1570212192308,'allen.kim',1570212277990,'allen.kim','');
